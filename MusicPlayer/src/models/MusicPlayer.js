class musicPlayer {
	constructor(songName,artistName,src) {
        ...
        this.time = this.infoBar.querySelector(".currentTime");
        this.duration = this.infoBar.querySelector(".duration");
        ...
        this.duration.innerHTML = this.player.duration;
	}
	...
	_playerDomElement(nameContent,artistContent){
        ...
        timeBar.appendChild(duration);
		info.appendChild(artist);
        info.appendChild(name);        
        info.appendChild(progressBar);
        info.appendChild(timeBar);       
	...
	updateData(){
        ...
        this.time.innerHTML = (this.player.currentTime / 60).toFixed(2);      

        this.duration.innerHTML = (this.player.duration / 60).toFixed(2);

        console.log(this.time.innerHTML + " Tiempo real" + this.player.currentTime);

        if (this.time.innerHTML == this.duration.innerHTML) {
